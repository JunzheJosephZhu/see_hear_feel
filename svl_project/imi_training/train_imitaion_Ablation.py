...
def main(args):
    ...
    v_encoder = make_vision_encoder(args.conv_bottleneck, args.embed_dim_v, (2, 2)) # 3,4/4,5
    t_encoder = make_tactile_encoder(args.conv_bottleneck, args.embed_dim_t, (4, 5))
