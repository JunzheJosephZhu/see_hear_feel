import torch
from svl_project.datasets.repr_dataset import GelsightFlowDataset
from svl_project.models.decoders import make_flow_decoder
from svl_project.models.encoders import make_flow_encoder
...
def main(args):
    train_set = GelsightFlowDataset(args.train_csv, args.data_folder)
    val_set = GelsightFlowDataset(args.val_csv, args.data_folder)
    ...
    t_decoder = make_flow_decoder(args.latent_dim)
