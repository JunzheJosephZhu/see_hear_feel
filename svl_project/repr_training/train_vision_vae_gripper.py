...
def main(args):
    ...
    v_encoder = make_vision_encoder_downsampled(args.conv_bottleneck, args.embed_dim)
    v_decoder = make_vision_decoder_downsampled(args.conv_bottleneck, args.embed_dim)
...
if __name__ == "__main__":
    ...
    p.add("-c", "--config", is_config_file=True, default="conf/repr/vision_vae_gripper.yaml")
