...
python svl_project/imi_training/train_imitaion_Ablation.py --ablation v --resume /viscam/u/josef/svl_project/exp/imi_learn_ablation/checkpoints/epoch=54-step=604.ckpt